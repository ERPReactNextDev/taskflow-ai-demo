        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="flex items-center gap-1 relative">
              ...
              {/* Viber quick-action button */}
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      type="button"
                      className="h-8 w-8 flex items-center justify-center rounded-lg border border-zinc-200 transition-all hover:opacity-80 active:scale-95"
                  ...
                  <TooltipContent>Open Viber</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </div>
          );
