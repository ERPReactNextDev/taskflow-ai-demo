...
`
          ...
          ? `
<tr style="border-bottom: 1px solid #e5e7eb;">
  <td class="sum-gray-lbl">Less: VAT Exe</td>
  <td class="sum-gray-val">− ₱${peso(round2(_total - _netOfVat))}</td>
</tr>
${payload.whtType && payload.whtType !== "none"
            ? `
<tr class="sum-divider">
  ...
  <td class="sum-ewt-val">− ₱${peso(_whtAmount)}</td>
            ...
            : `
<tr class="sum-divider">
  <td class="sum-gray-lbl" style="font-style:italic;">Tax Status</td>
  <td class="sum-gray-val" style="font-style:italic;">VAT Exempt</td>
</tr>`
          }
`
          : `
