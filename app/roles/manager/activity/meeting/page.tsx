...
function MeetingsContent() {
  ...
  const fetchMeetings = useCallback(async (soft = false) => {
    ...
    try {
      ...
      const params = new URLSearchParams({ manager: userDetails.referenceid, limit: "500" });
  ...
  return (
    <ProtectedPageWrapper>
      ...
      <SidebarInset className="overflow-hidden">
        <GlobalTopBar title="Team Meetings" rightExtra={
        ...
        <MeetingFormModal open={createOpen} onClose={() => setCreateOpen(false)}
          ...
          defaults={{ referenceid: userDetails.referenceid, tsm: userDetails.tsm, manager: userDetails.referenceid }}
          canOverrideConflict />
