 ...
 * AP prefix  → show AP (KPI) cards only  (activity pattern OFF)
 * BR prefix  → show BR (Activity) cards only  (KPI pattern OFF)
 * anything else / empty → use DEFAULT_VISIBILITY
 */
function defaultForManager(manager?: string): CardVisibility {
  if (!manager) return { ...DEFAULT_VISIBILITY };
