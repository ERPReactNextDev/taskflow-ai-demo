...
function MeetingsContent() {
  ...
  const fetchMeetings = useCallback(async (soft = false) => {
    ...
    try {
      ...
      const params = new URLSearchParams({ tsm: userDetails.referenceid, limit: "500" });
    ...
    <ProtectedPageWrapper>
      ...
      <SidebarInset className="overflow-hidden">
        ...
        <MeetingFormModal open={createOpen} onClose={() => setCreateOpen(false)}
          ...
          defaults={{ referenceid: userDetails.referenceid, tsm: userDetails.referenceid, manager: userDetails.manager }}
          canOverrideConflict />
